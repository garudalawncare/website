...
## v1.5.1 — 2026-07-18
- Repackaged full site with all fixes from v1.5
- Fixed duplicate h3 headings on services.html (Sod Installation, Spring & Fall Cleanup)
- Fixed h4 hierarchy on index.html and services.html (h4 → h3)
- Expanded contact.html intro text
- New bold equipment sketches on all tiles and service badges
- All H1 headings updated on 8 pages

## v1.6.1 — 2026-09-25
- Business hours corrected to 7 AM – 9 PM, 7 days a week (closes 21:00 in structured data)
